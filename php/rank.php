...
<html lang="it">
	...
	<body onload="RankEventHandler.singleplayer_rank()">
		<?php 
		...
		<div class="head_section">Ranking</div>
			...
			<div class="tabs">    
			   	<div class="tab">
			      	<input type="radio" name="tabgroup" id="tab-1" onchange="RankEventHandler.singleplayer_rank()" checked>
			      	<label for="tab-1">Best Score Singleplayer</label>
			      
			   	</div>
				<div class="tab">
			      <input type="radio" name="tabgroup" onchange="RankEventHandler.multiplayer_rank()" id="tab-2">
			      <label for="tab-2">Match played Multiplayer</label>
